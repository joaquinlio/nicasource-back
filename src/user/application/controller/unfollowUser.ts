...
import { UnfollowUser } from "../../domain/useCases/unfollowUser";

type Model = Error | void;

export class UnfollowUserController extends Controller {
  constructor(private readonly unfollowUser: UnfollowUser) {
    super();
  }
